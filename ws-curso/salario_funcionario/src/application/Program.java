...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println("Informe o id do funcionário que terá o salário incrementado: ");
	...
	public static boolean posicaoId(List <Funcionario> lista, int id) {
